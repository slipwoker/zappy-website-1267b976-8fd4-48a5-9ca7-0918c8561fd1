document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        const showError = (input, message) => {
            ...
            errorSpan.style.cssText = 'color: #e53e3e; font-size: 0.875rem; margin-top: 0.25rem; display: block;';
        ...
        const validateField = (input) => {
            ...
            if (input.type === 'email' && value && !validateEmail(value)) {
                showError(input, input.getAttribute('data-error-email') || 'Please enter a valid email address');
                return false;
            }
            
            if (input.hasAttribute('minlength') && value.length < parseInt(input.getAttribute('minlength'))) {
                showError(input, input.getAttribute('data-error-minlength') || `Minimum ${input.getAttribute('minlength')} characters required`);
                return false;
            }
            ...
            if (input.hasAttribute('pattern') && value) {
                ...
                if (!pattern.test(value)) {
                    showError(input, input.getAttribute('data-error-pattern') || 'Invalid format');
                    return false;
                }
            }
            ...
            if (isValid) {
                ...
                fetch(action, options)
                    ...
                    .then(() => {
                        ...
                        successMsg.style.cssText = 'color: #38a169; padding: 1rem; margin-top: 1rem; border: 1px solid #38a169; border-radius: 0.25rem;';
                        successMsg.textContent = contactForm.getAttribute('data-success-message') || 'Thank you! Your message has been sent successfully.';
                        contactForm.reset();
                    ...
                    .catch(() => {
                        ...
                        errorMsg.className = 'form-error-global';
                        errorMsg.style.cssText = 'color: #e53e3e; padding: 1rem; margin-top: 1rem; border: 1px solid #e53e3e; border-radius: 0.25rem;';
                        errorMsg.textContent = contactForm.getAttribute('data-error-message') || 'Something went wrong. Please try again later.';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1267b976-8fd4-48a5-9ca7-0918c8561fd1',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1267b976-8fd4-48a5-9ca7-0918c8561fd1';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1267b976-8fd4-48a5-9ca7-0918c8561fd1';
